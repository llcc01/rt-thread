...
typedef struct
{
  rt_uint32_t         Speed;                       /*!< Sets the Ethernet speed: 10/100/1000 Mbps.
                                                           This parameter can be a value of @ref ETH_Speed */
  rt_uint32_t         DuplexMode;                  /*!< Selects the MAC duplex mode: Half-Duplex or Full-Duplex mode
...
#define RTL8211F_BMCR     ((rt_uint16_t)0x0000U) /* Basic Mode Control Register. */
#define RTL8211F_BMSR     ((rt_uint16_t)0x0001U) /* Basic Mode Status Register. */
#define RTL8211F_PHYID1   ((rt_uint16_t)0x0002U) /* PHY Identifier Register 1. */
#define RTL8211F_PHYID2   ((rt_uint16_t)0x0003U) /* PHY Identifier Register 2. */
#define RTL8211F_ANAR     ((rt_uint16_t)0x0004U) /* Auto-Negotiation Advertising Register. */
#define RTL8211F_ANLPAR   ((rt_uint16_t)0x0005U) /* Auto-Negotiation Link Partner Ability Register. */
#define RTL8211F_ANER     ((rt_uint16_t)0x0006U) /* Auto-Negotiation Expansion Register.*/
#define RTL8211F_ANNPTR   ((rt_uint16_t)0x0007U) /* Auto-Negotiation Next Page Transmit Register.*/
#define RTL8211F_ANNPRR   ((rt_uint16_t)0x0008U) /* Auto-Negotiation Next Page Receive Register. */
#define RTL8211F_GBCR     ((rt_uint16_t)0x0009U) /* 1000Base-T Control Register. */
#define RTL8211F_GBSR     ((rt_uint16_t)0x000AU) /* 1000Base-T Status Register. */
#define RTL8211F_MMDACR   ((rt_uint16_t)0x000DU) /* MMD Access Control Register. */
#define RTL8211F_MMDAADR  ((rt_uint16_t)0x000EU) /* MMD Access Address Data Register. */
#define RTL8211F_GBESR    ((rt_uint16_t)0x000FU) /* 1000Base-T Extended Status Register. */
#define RTL8211F_INER     ((rt_uint16_t)0x0012U) /* Interrupt Enable Register. */
#define RTL8211F_PHYSCR   ((rt_uint16_t)0x0014U) /* PHY Special Cofig Register */
#define RTL8211F_PHYCR1   ((rt_uint16_t)0x0018U) /* PHY Specific Control Register 1. */
#define RTL8211F_PHYCR2   ((rt_uint16_t)0x0019U) /* PHY Specific Control Register 2. */
#define RTL8211F_PHYSR    ((rt_uint16_t)0x001AU) /* PHY Specific Status Register. */
#define RTL8211F_INSR     ((rt_uint16_t)0x001DU) /* Interrupt Status Register. */
#define RTL8211F_PAGSR    ((rt_uint16_t)0x001FU) /* Page Select Register. */

#define RTL8211F_PAGE_LCR      ((rt_uint16_t)0x0010U) /* LED Control Register. */
#define RTL8211F_PAGE_EEELCR      ((rt_uint16_t)0x0011U) /* EEE LED Control Register. */
