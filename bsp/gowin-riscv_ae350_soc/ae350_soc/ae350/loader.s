...
.Ltext0:
	...
	.file 0 "/home/lc/git/rt-thread/bsp/gowin-riscv_ae350_soc" "ae350_soc/ae350/loader.c"
...
boot_loader:
.LFB0:
	.file 1 "ae350_soc/ae350/loader.c"
	.loc 1 25 1
	.cfi_startproc
	.loc 1 30 2
 #APP
# 30 "ae350_soc/ae350/loader.c" 1
	.option norelax

# 0 "" 2
	.loc 1 35 10
 #NO_APP
	lla	a5,__loader_lmaend
	.loc 1 35 78
	addi	a4,a5,3
	.loc 1 35 44
	lla	a5,__loader_lmastart
	.loc 1 35 78
	sub	a5,a4,a5
	.loc 1 35 7
	srli	s2,a5,2
	.loc 1 37 30
	lla	a4,__flash_start
	.loc 1 37 62
	lla	a5,__loader_lmastart
	.loc 1 37 60
	add	a5,a4,a5
...
.LASF0:
	.string	"ae350_soc/ae350/loader.c"
	.ident	"GCC: () 13.2.0"
