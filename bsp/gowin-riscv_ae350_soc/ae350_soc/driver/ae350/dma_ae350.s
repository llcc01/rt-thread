...
.Ltext0:
	...
	.file 0 "/home/lc/git/rt-thread/bsp/gowin-riscv_ae350_soc" "ae350_soc/driver/ae350/dma_ae350.c"
	.section	.sbss.channel_active,"aw",@nobits
	.align	2
	.type	channel_active, @object
	.size	channel_active, 4
channel_active:
	.zero	4
	.section	.sbss.init_cnt,"aw",@nobits
	.align	2
	.type	init_cnt, @object
	.size	init_cnt, 4
init_cnt:
	.zero	4
	.section	.bss.channel_info,"aw",@nobits
	.align	2
	.type	channel_info, @object
	.size	channel_info, 160
channel_info:
	.zero	160
	.section	.text.set_channel_active_flag,"ax",@progbits
	.align	1
	.type	set_channel_active_flag, @function
set_channel_active_flag:
.LFB16:
	.file 1 "ae350_soc/driver/ae350/dma_ae350.c"
	.loc 1 65 1
	.cfi_startproc
	addi	sp,sp,-64
...
.LBB12:
	.loc 1 66 41
 #APP
# 66 "ae350_soc/driver/ae350/dma_ae350.c" 1
	csrr a5, 0x300
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LBB13:
	.loc 1 71 27
 #APP
# 71 "ae350_soc/driver/ae350/dma_ae350.c" 1
	csrrc a5, 0x300, 8
# 0 "" 2
 #NO_APP
	sw	a5,-28(s0)
...
.LBB14:
	.loc 1 79 28
 #APP
# 79 "ae350_soc/driver/ae350/dma_ae350.c" 1
	csrrs a5, 0x300, 8
# 0 "" 2
 #NO_APP
	sw	a5,-36(s0)
...
.LBB15:
	.loc 1 89 27
 #APP
# 89 "ae350_soc/driver/ae350/dma_ae350.c" 1
	csrrs a5, 0x300, 8
# 0 "" 2
 #NO_APP
	sw	a5,-32(s0)
...
.L5:
	...
	.cfi_endproc
.LFE16:
	.size	set_channel_active_flag, .-set_channel_active_flag
	.section	.text.clear_channel_active_flag,"ax",@progbits
	.align	1
	.type	clear_channel_active_flag, @function
clear_channel_active_flag:
.LFB17:
	.loc 1 101 1
	.cfi_startproc
	addi	sp,sp,-48
...
.LBB16:
	.loc 1 102 41
 #APP
# 102 "ae350_soc/driver/ae350/dma_ae350.c" 1
	csrr a5, 0x300
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LBB17:
	.loc 1 107 27
 #APP
# 107 "ae350_soc/driver/ae350/dma_ae350.c" 1
	csrrc a5, 0x300, 8
# 0 "" 2
 #NO_APP
	sw	a5,-28(s0)
...
.LBB18:
	.loc 1 115 27
 #APP
# 115 "ae350_soc/driver/ae350/dma_ae350.c" 1
	csrrs a5, 0x300, 8
# 0 "" 2
 #NO_APP
	sw	a5,-32(s0)
...
.LBE18:
	...
	.cfi_endproc
.LFE17:
	.size	clear_channel_active_flag, .-clear_channel_active_flag
	.section	.text.dma_initialize,"ax",@progbits
	.align	1
	.globl	dma_initialize
	.type	dma_initialize, @function
dma_initialize:
.LFB18:
	.loc 1 127 1
	.cfi_startproc
...
.LBB24:
	...
	addi	a5,a5,-2048
 #APP
# 161 "ae350_soc/driver/ae350/dma_ae350.c" 1
	csrrs a5, 0x304, a5
# 0 "" 2
 #NO_APP
	sw	a5,-24(s0)
...
.LBB25:
	.loc 1 164 26
 #APP
# 164 "ae350_soc/driver/ae350/dma_ae350.c" 1
	csrrs a5, 0x300, 8
# 0 "" 2
 #NO_APP
	sw	a5,-28(s0)
...
.L13:
	...
	.cfi_endproc
.LFE18:
	.size	dma_initialize, .-dma_initialize
	.section	.text.dma_uninitialize,"ax",@progbits
	.align	1
	.globl	dma_uninitialize
	.type	dma_uninitialize, @function
dma_uninitialize:
.LFB19:
	.loc 1 177 1
	.cfi_startproc
...
.L18:
	...
	.cfi_endproc
.LFE19:
	.size	dma_uninitialize, .-dma_uninitialize
	.section	.text.dma_channel_configure,"ax",@progbits
	.align	1
	.globl	dma_channel_configure
	.type	dma_channel_configure, @function
...
.L23:
	...
	lw	a1,-48(s0)
	lw	a0,-40(s0)
	call	ae350_dma_writeback_range
.L24:
	.loc 1 241 15
	lw	a4,-52(s0)
	li	a5,131072
	...
	lw	a1,-48(s0)
	lw	a0,-44(s0)
	call	ae350_dma_invalidate_range
.L25:
	.loc 1 248 18
	lbu	a4,-33(s0)
	.loc 1 248 28
...
.L29:
	...
	lbu	a5,-33(s0)
	mv	a0,a5
	call	clear_channel_active_flag
.L31:
	.loc 1 323 9
	li	a5,0
.L22:
	...
	.cfi_endproc
.LFE20:
	.size	dma_channel_configure, .-dma_channel_configure
...
.L39:
	...
	lw	a1,-28(s0)
	lw	a0,-20(s0)
	call	ae350_dma_invalidate_range2
.L41:
	.loc 1 396 2
	lbu	a5,-33(s0)
	mv	a0,a5
...
.LFE22:
	...
	.section	.text.dma_channel_abort,"ax",@progbits
	.align	1
	.globl	dma_channel_abort
	.type	dma_channel_abort, @function
dma_channel_abort:
.LFB23:
	.loc 1 412 1
	.cfi_startproc
...
.L44:
	...
	.cfi_endproc
.LFE23:
	.size	dma_channel_abort, .-dma_channel_abort
	.section	.text.dma_channel_get_status,"ax",@progbits
	.align	1
	.globl	dma_channel_get_status
	.type	dma_channel_get_status, @function
...
.L50:
	...
	.cfi_endproc
.LFE24:
	.size	dma_channel_get_status, .-dma_channel_get_status
	.section	.text.dma_channel_get_count,"ax",@progbits
	.align	1
	.globl	dma_channel_get_count
	.type	dma_channel_get_count, @function
...
.L54:
	...
	.cfi_endproc
.LFE25:
	.size	dma_channel_get_count, .-dma_channel_get_count
	.section	.text.dma_irq_handler,"ax",@progbits
	.align	1
	.globl	dma_irq_handler
	.type	dma_irq_handler, @function
dma_irq_handler:
.LFB26:
	.loc 1 513 1
	.cfi_startproc
...
.L65:
	...
	.loc 1 603 8
	beq	a5,zero,.L67
	.loc 1 603 75 discriminator 1
	lw	a5,-28(s0)
	.loc 1 603 32 discriminator 1
	blt	a5,zero,.L67
	.loc 1 605 7
	lw	a1,-40(s0)
	lw	a0,-28(s0)
...
.L56:
	...
	.cfi_endproc
.LFE26:
	.size	dma_irq_handler, .-dma_irq_handler
	.text
.Letext0:
	.file 3 "/home/lc/tools/riscv32-unknown-elf/lib/gcc/riscv32-unknown-elf/13.2.0/include/stdint-gcc.h"
	.file 4 "ae350_soc/driver/ae350/../../../ae350_soc/driver/ae350/../../../ae350_soc/ae350/../../ae350_soc/ae350/ae350.h"
	.file 5 "ae350_soc/driver/ae350/../../../ae350_soc/driver/ae350/dma_ae350.h"
	.file 6 "ae350_soc/ae350/../../ae350_soc/ae350/cache.h"
...
.Ldebug_macro0:
	...
	.uleb128 0xb
	.4byte	.LASF348
	.file 7 "/home/lc/tools/riscv32-unknown-elf/lib/gcc/riscv32-unknown-elf/13.2.0/include/stdint.h"
	.byte	0x3
	.uleb128 0xf
	.uleb128 0x7
	.byte	0x3
	...
	.4byte	.LASF472
	.byte	0x4
	.file 8 "ae350_soc/driver/ae350/../../../ae350_soc/driver/ae350/../../../ae350_soc/ae350/platform.h"
	.byte	0x3
	.uleb128 0x10
	.uleb128 0x8
	.byte	0x5
	.uleb128 0xb
	.4byte	.LASF473
	.file 9 "ae350_soc/driver/ae350/../../../ae350_soc/driver/ae350/../../../ae350_soc/ae350/../../ae350_soc/config/config.h"
	.byte	0x3
	.uleb128 0x14
	.uleb128 0x9
	.byte	0x7
	.4byte	.Ldebug_macro3
	.byte	0x4
	.file 10 "ae350_soc/driver/ae350/../../../ae350_soc/driver/ae350/../../../ae350_soc/ae350/../../ae350_soc/ae350/core_v5.h"
	.byte	0x3
	.uleb128 0x15
	.uleb128 0xa
	.byte	0x7
	.4byte	.Ldebug_macro4
	.file 11 "ae350_soc/driver/ae350/../../../ae350_soc/driver/ae350/../../../ae350_soc/ae350/../../ae350_soc/ae350/../../ae350_soc/ae350/csr.h"
	.byte	0x3
	.uleb128 0x94
	.uleb128 0xb
	.byte	0x7
	...
	.4byte	.Ldebug_macro7
	.byte	0x4
	.file 12 "ae350_soc/driver/ae350/../../../ae350_soc/driver/ae350/../../../ae350_soc/ae350/../../ae350_soc/ae350/interrupt.h"
	.byte	0x3
	.uleb128 0x17
	.uleb128 0xc
	.byte	0x7
	...
	.uleb128 0xb
	.4byte	.LASF1118
	.file 13 "ae350_soc/ae350/../../ae350_soc/ae350/../../ae350_soc/ae350/core_v5.h"
	.byte	0x3
	.uleb128 0xf
	.uleb128 0xd
	.byte	0x4
...
.LASF1122:
	.string	"IS_ADDR_IN_RAM(addr) ((addr >= DRAM_START) && (addr <= DRAM_END))"
.LASF355:
...
.LASF1124:
	.string	"DMA_DCACHE_INVALID(start,size) ae350_dma_invalidate_range(start, size)"
.LASF697:
...
.LASF1121:
	.string	"DRAM_END 0x7FFFFFFFU"
.LASF170:
	.string	"__DBL_MAX_EXP__ 1024"
.LASF14:
	.string	"__ATOMIC_RELEASE 3"
.LASF1164:
	.string	"DMA_Channel_Info"
.LASF149:
...
.LASF1125:
	.string	"DMA_DCACHE_INVALID_AFTER(start,size) ae350_dma_invalidate_range2(start, size)"
.LASF1118:
	.string	"__CACHE_H__ "
.LASF1088:
...
.LASF1197:
	.string	"set_channel_active_flag"
.LASF1155:
	.string	"CHEN"
.LASF1100:
...
.LASF1123:
	.string	"DMA_DCACHE_WRITEBACK(start,size) ae350_dma_writeback_range(start, size)"
.LASF579:
	.string	"LOAD lw"
.LASF193:
...
.LASF1196:
	.string	"clear_channel_active_flag"
.LASF895:
...
.LASF1119:
	.string	"DMA_CHANNEL(n) ((DMA_CHANNEL_REG *)&(DEV_DMA->CHANNEL[n]))"
.LASF1183:
...
.LASF0:
	.string	"ae350_soc/driver/ae350/dma_ae350.c"
.LASF1:
